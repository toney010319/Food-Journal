...
const MealtypeGroup = ({ mealType, journalEntries }) => {
  ...
  return (
    <>
      <div>
        {" "}
        <h1 className="  border-x-2 border-t-2 border-[#128447] rounded-t-lg max-w-sm text-center text-2xl font-bold bg-[#cad456]">
          {mealType.toUpperCase()}
        </h1>
        <div className=" border-x-2 border-b-2 border-[#128447] overflow-y-scroll flex flex-col rounded-b-lg min-h-[45rem] max-h-[45rem] max-w-sm h-3/4 bg-[#f1f1f1e3] ">
